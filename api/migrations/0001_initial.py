# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-16 01:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('default', 'Default color'), ('primary', 'Primary color'), ('accent', 'Accent color')], default='default', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('default', 'Default color'), ('primary', 'Primary color'), ('accent', 'Accent color')], default='default', max_length=255)),
